...
export const ADMIN_CARDS_DATA = 'ADMIN_CARDS_DATA';
...
export const VERIFY_RESETID_REQUEST = 'VERIFY_RESETID_REQUEST';
...
export const CURRENT_PASSWORD_SUCCESS = 'CURRENT_PASSWORD_SUCCESS';
...
export const CHANGE_PROFILE_PIC_REQUEST = 'CHANGE_PROFILE_PIC_REQUEST';
export const ADD_CARD = 'ADD_CARD';
export const EDIT_CARD = 'EDIT_CARD';
export const UPDATE_HEADER_PIC = 'UPDATE_HEADER_PIC';
export const ADD_TO_CART_REQUEST = 'ADD_TO_CART_REQUEST';
export const CHANGE_PASSWORD_UNMOUNT = 'CHANGE_PASSWORD_UNMOUNT';
...
export const CARDS_UNMOUNT = 'CARDS_UNMOUNT';
export const FORGOT_PASSWORD_UNMOUNT = 'FORGOT_PASSWORD_UNMOUNT';
